...
- **POC validation scripts:**
  ...
  For the standalone clinical trial matching POC, use:
  ...
  These focused scripts validate document upload preparation, fresh extraction consistency helpers, matching mode guardrails, and criteria-change detection without requiring a full backend test framework.
...
in order to do contributions to this repo please use fork method to clone the repo and then submit your part by creating pull request. direct commits are not allowed if any one does that he/she will face serious consequences.
